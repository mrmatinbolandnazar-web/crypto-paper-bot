#!/usr/bin/env python3
# Binance Paper Trading Bot V5.2B ACTIVE — SIMULATION ONLY
...
STATE_FILE = "paper_state_v5_2_active.json"
TRADES_FILE = "paper_trades_v5_2_active.csv"
...
def main():
    print("=" * 96)
    print("BINANCE PAPER TRADING BOT V5.2B ACTIVE — PARALLEL SIMULATION ONLY")
